  ...
  setValue: function(value, initial) {
    ...
    $each(value,function(i,val) {
      if(self.rows[i]) {
		...
		// $(self.rows[i].container).show(400);
  ...
  addControls: function() {
    ...
    this.toggle_button.addEventListener('click',function(e) {
      ...
      if(self.collapsed) {
		...
		$(self.row_holder).hide(400);
        if(self.tabs_holder){
			// self.tabs_holder.style.display = 'none';
			$(self.tabs_holder).hide(400);
		}
...
JSONEditor.AbstractTheme = Class.extend({
  ...
  getTabHolder: function() {
    var el = document.createElement('div');
    el.innerHTML = "<div style='float: left; width: 200px;' class='tabs'></div><div class='content' style='margin-left: 150px;'></div><div style='clear:both;'></div>";
    return el;
  },
